        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    ...
                    <img src="{{ asset($product->image[0]->gambar_produk) }}" alt="">
                    <img src="{{ asset($product->image[1]->gambar_produk) }}" alt="">
                    <img src="{{ asset($product->image[2]->gambar_produk) }}" alt="">
           ...
           {{-- <form action="{{ route('keranjang.store') }}" method="POST">
                ...
                <div class="right-content">
                    ...
                    <span>Deskripsi {{ $product->deskripsi }}</span>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        <div class="logo">
                            <img src="{{ asset('assets1/images/white-logo.png')}}" alt="hexashop ecommerce templatemo">
                        </div>
                        <ul>
