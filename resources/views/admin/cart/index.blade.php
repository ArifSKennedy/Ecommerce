...
@section('content')
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            <button type="button" class="btn mb-3 btn-primary float-end" data-bs-toggle="modal" data-bs-target="#kerModal">
                Tambah Data
            </button>
            @include('admin.cart.create')
        </div>
                                    ...
                                    <td>
                                        <form action="{{ route('cart.destroy', $cart->id) }}" method="post">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $cart->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $cart->id }}" tabindex="-1"
                                                aria-hidden="true">
