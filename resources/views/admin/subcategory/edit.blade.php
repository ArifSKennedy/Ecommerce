            ...
            <div class="col-lg-12">
                <div class="card mb-4 shadow-lg rounded card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0">Tambah sub kategori</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <select name="category_id" class="form-select @error('category_id') is-invalid @enderror">
                                @foreach ($categorys as $category)
                                    @if (old('category_id', $category->id) == $subcategorys->category->id)
                ...
                <div class="d-flex float-start">
                    <a href="/admin/subcategory" class="btn btn-danger me-3"><svg xmlns="http://www.w3.org/2000/svg"
