...
@section('content')
    ...
    <div class="card shadow-lg rounded card p-2">
        <div class="card-header" id="#atas">
            ...
            <button type="button" class="btn mb-3 btn-success float-end" data-bs-toggle="modal" data-bs-target="#subModal">
                Tambah Data
            </button>
                                    ...
                                    <td>
                                        <form action="{{ route('subcategory.destroy', $subcategory->id) }}" method="post">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#modalCenter{{ $subcategory->id }}"><svg
                                            ...
                                            <!-- Modal -->
                                            <div class="modal fade" id="modalCenter{{ $subcategory->id }}" tabindex="-1"
                                                aria-hidden="true">
